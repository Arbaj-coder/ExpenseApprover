        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Streamline your organization's budget management and employee administration with our comprehensive solution.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Employee List</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Expense Reports</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Budget Planning</a></li>
          ...
          {/* Support & Legal */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-blue-400">Support & Legal</h4>
            <ul className="space-y-2">
